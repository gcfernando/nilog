...
public class GuardTests
{
    ...
    {
        Assert.Throws<ArgumentNullException>(() => Nilogger.Log(Null, LogLevel.Information, "x"));
    }

    [Fact]
    public void LogTyped_NullLogger_Throws()
    {
        Assert.Throws<ArgumentNullException>(() => Nilogger.Log(Null, LogLevel.Information, "x {A}", 1));
    }
    ...
    {
        Assert.Throws<ArgumentNullException>(() => Null.WriteInformation("x"));
    }
    ...
    {
        var logger = new TestLogger();
        Assert.Throws<ArgumentNullException>(() => logger.WriteInformation(null!));
    }
    ...
    {
        var logger = new TestLogger();
        Assert.Throws<ArgumentNullException>(() => logger.WriteError("msg", (Exception)null!));
    }
    ...
    {
        var logger = new TestLogger();
        Assert.Throws<ArgumentNullException>(() => logger.WriteError("msg {A}", (Exception)null!, 1));
    }

    [Fact]
    public void WriteErrorException_NullLogger_Throws()
    {
        Assert.Throws<ArgumentNullException>(() => Null.WriteErrorException(new Exception()));
    }
    ...
    {
        var logger = new TestLogger();
        Assert.Throws<ArgumentNullException>(() => logger.WriteErrorException(null!));
    }

    [Fact]
    public void WriteScope_NullLogger_Throws()
    {
        Assert.Throws<ArgumentNullException>(() => Null.WriteScope("k", "v"));
    }
    ...
    {
        var logger = new TestLogger();
        Assert.Throws<ArgumentException>(() => logger.WriteScope(key!, "v"));
    }
